...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*
        1. skipInitialValue() untuk menghiraukan input awal. Hal ini bertujuan supaya aplikasi tidak langsung menampilkan eror pada saat pertama kali dijalankan.
        2. Anda menggunakan operator map dan memeriksa apakah format valid. Jika format tidak valid
        maka ia akan mengembalikan nilai TRUE. Kemudian saat subscribe, kita memanggil fungsi
        showEmailExistAlert(it) untuk menampilkan peringatan jika hasilnya TRUE.
        3. adanya variabel karena Anda memerlukan data stream tersebut untuk menentukan Button aktif atau tidak
         */
